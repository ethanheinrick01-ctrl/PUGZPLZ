...
(function (root) {
  ...
  L.ITEMS.push(
    ...
    { id: 'x.time2', c: 'timing', t: 'mc', q: 'Perinatal means:',
      o: [['Around birth', 'Slide 5.'], ['Before birth', 'That is prenatal.'], ['After birth', 'That is postnatal.'], ['Before conception', 'That is not perinatal.']], a: 0, x: 'Slide 5.', s: ['L2-5'], tier: 1, pool: 'x' },
    ...
    { id: 'x.hiv2', c: 'hiv', t: 'mc', q: "About what is the risk of HIV transmission from an infected mother to the fetus?",
      o: [['10-40%', 'Slide 30.'], ['1-9%', 'Below the range taught in slide 30.'], ['41-70%', 'Above the range taught in slide 30.'], ['71-90%', 'Above the range taught in slide 30.']], a: 0, x: 'Early treatment of the pregnant woman helps (slide 30).', s: ['L2-30'], tier: 1 },
    ...
    { id: 'x.val2', c: 'peds-validation', t: 'mc', q: "Who provides much of the information used to validate pediatric amplification, often through questionnaires?",
      o: [['Parents and caregivers', 'Slide 51 emphasizes parent and caregiver reports.'], ['Audiologists using real-ear measures', 'Those are verification measures.'], ['Manufacturers using test-box measures', 'Those are electroacoustic measures.'], ['Software selecting prescriptive targets', 'That chooses fitting targets.']], a: 0, x: 'Slide 51 cites tools such as IT-MAIS, PEACH and ELF.', s: ['L3-51'], tier: 1 },
